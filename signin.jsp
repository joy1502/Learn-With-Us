...
<body>
    <div class="flex flex-col lg:flex lg:flex-row   justify-center items-center lg:hid">
        ...
        <div class="md:w-1/2 h-screen  p-4 rounded-md shadow sm:p-8 bd-red-200 dark:text-gray-100">
           ...
           <p class="text-sm text-center dark:text-gray-400 ">Already have account?
               <a href="./signinTeacher.jsp" rel="noopener noreferrer" class="focus:underline hover:underline">Sign in As Teacher</a>
            </p>
            ...
            <form novalidate="" action="./LoginPage.jsp" class="space-y-8 ng-untouched ng-pristine ng-valid" method="post" >
                <div class="space-y-4">
                    <div class="space-y-2">
                        <label for="email" class="block text-[#fff] text-md font-semibold">Email address</label>
                        <input type="email" name="email" id="email" placeholder="email" class="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400">
                    </div>
                    <div class="space-y-2">
                        ...
                        <input type="password" name="password" id="password" placeholder="*****" class="w-full px-3 py-2 border rounded-md dark:border-gray-700  text-black 100 focus:dark:border-violet-400">
                    </div>
                </div> 
