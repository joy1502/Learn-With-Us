<%-- 
    ...
    Created on : 24 Nov, 2022, 3:29:27 PM
    Author     : shata
--%>
    ...
    <div class="flex flex-col lg:flex lg:flex-row   justify-center items-center lg:hid">
        ...
        <div class="md:w-1/2 h-screen  p-4 rounded-md shadow sm:p-8 bd-red-200 dark:text-gray-100">
            ...
            <p class="text-sm text-center dark:text-gray-400 ">
                <a href="#" rel="noopener noreferrer" class="focus:underline hover:underline">Contact</a>
            </p>
            ...
            <form novalidate="" action="./loginPageAdmin.jsp" class="space-y-8 ng-untouched ng-pristine ng-valid" method="post" >
                <div class="space-y-4">
                    <div class="space-y-2">
                        <label for="email" class="block text-[#fff] text-md font-semibold">Email address</label>
                        <input type="email" name="emailA" id="email" placeholder="leroy@jenkins.com" class="w-full px-3 py-2 border rounded-md dark:border-gray-700 dark:text-gray-100 focus:dark:border-violet-400">
                    </div>
                    <div class="space-y-2">
                        ...
                        <input type="password" name="passwordA" id="password" placeholder="*****" class="w-full px-3 py-2 border rounded-md dark:border-gray-700  text-black 100 focus:dark:border-violet-400">
                    </div>
                </div> 
