<%-- 
    ...
    Created on : 13 Nov, 2022, 10:09:04 PM
    Author     : shata
--%>
...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section dashboard">
        ...
        <form class="row g-3" action="./searchStudent.jsp" method="post" enctype="multipart/form-data" >
        <h3>View Students</h3>
        <div class="mb">
          <label for="exampleInputEmail1" class="form-label">Search</label>
          <input type="text" class="form-control" id="exampleInputEmail1" name="name2">
	...
	try{
		    ...
		    String query = "select * from student_information where name='"+name+"';";
